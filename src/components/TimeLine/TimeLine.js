...
const Timeline = () => {
    ...
    return (
        <Section id="about">
            <SectionTitle>About Nenad</SectionTitle>
            <SectionText>
                Nenad Vasilic is a seasoned SDET whose dedication to innovation
                and progress has earned him the reputation as a strategist in
